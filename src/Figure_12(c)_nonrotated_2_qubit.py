...
Simulates non-rotated XZZX code + two-qubit XZ noise
"""
...
# initialize codes
codes = [PlanarCodeXZ(*size) for size in [(3, 3), (7, 7), (11, 11), (15, 15), (19, 19), (23, 23)]]
...
plt.yscale('log')
plt.show()
fig.savefig('./Fig_12c_quantum.pdf', format='pdf', bbox_inches='tight')
